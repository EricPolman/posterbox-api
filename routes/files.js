...
function upload(req, callback) {
    ...
    busboy.on("file", function (fieldname, file, filename, encoding, mimetype) {
        ...
        diskWriterStream.on("finish", function () {
            ...
            if(getExtension(saveToPath) === "png") {
                console.log(saveToPath.slice(0, -4) + ".thumbnail.png");
                // create thumbnail
                return sharp(saveToPath).resize(240).png()
                    .toFile(saveToPath.slice(0, -4) + ".thumbnail.png")
                    .then(function() {
